$(function() {
	...
	_.each(letter.children, function(polygon) {
		_.each(polygon.vertices, function(anchor) {
			...
			var ll = new Two.Path([ new Two.Anchor().copy(p.translation), new Two.Anchor().copy(l.translation) ]);
			var rl = new Two.Path([ new Two.Anchor().copy(p.translation), new Two.Anchor().copy(r.translation) ]);
